<div class="space-y-6">
    <div class="bg-white shadow rounded-lg p-4 space-y-4">
        ...
        <div>
            ...
            <textarea wire:model.defer="form.body" rows="3" class="mt-1 block w-full rounded-md border-gray-300"></textarea>
        </div>
        <div class="text-right">
            <x-primary-button type="button" wire:click="saveNote">
                Save Note
            </x-primary-button>
        </div>
    </div>
